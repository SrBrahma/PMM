...
void PmmErrorsAndSignals::reportError(pmmErrorType errorId, unsigned long packetID)
{
...
void PmmErrorsAndSignals::reportRecuperation(unsigned long packetID)
{
...
void PmmErrorsAndSignals::generalMessage(char *string, unsigned long packetID, int mSdIsWorking, int mTelemetryIsWorking)
{
