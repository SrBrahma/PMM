...
// For each module, you should have 
class PmmSdSafeLog
{
...
public:
    ...
    typedef struct
    {
        ...
        uint16_t freeBlocks;       // The absoluteEndBlock is actualBlock + freeBlocks. Even if it is 0, there may still have free bytes on the actual block.
...
private:
    ...
    safeLogBufferStructType mSafeLogBufferStructArray[];

    unsigned mBuffersNumber;
