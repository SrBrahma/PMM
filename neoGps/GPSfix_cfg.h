 ...
 *
 */
#ifndef PMM_GPS_EXTERNAL_CONFIGURATION // Minerva Rockets alteration.
// Here are the defaults defines of the code, if using a PMM (Minerva Rockets).
    //#define GPS_FIX_DATE
    //#define GPS_FIX_TIME
    #define GPS_FIX_LOCATION // Latitude and longitude
    //#define GPS_FIX_LOCATION_DMS
    #define GPS_FIX_ALTITUDE
    #define GPS_FIX_SPEED // Usually you will want
