...
class ModuleSimpleDataLogTx : public ModuleSimpleDataLogCore
{
...
public:
    ...
    int  addBasicInfo          (uint32_t* mainLoopCounterPtr, uint32_t* timeMillisPtr); 
    ...
    int  addGpsLatLong         (uint32_t *latitude, uint32_t *longitude);
